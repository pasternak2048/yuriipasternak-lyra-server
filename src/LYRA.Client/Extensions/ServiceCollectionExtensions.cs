...
namespace LYRA.Client.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
            ...
            Action<LyraSigningOptions> configure)
        {
            ...
            services.AddSingleton<ILyraClient>(sp =>
                new LyraClient(
                    signing: sp.GetRequiredService<SigningService>(),
                    verify: null));
        ...
        /// <param name="verifyPath">Relative verify path (default: "api/verification/verify")</param>
        public static IServiceCollection AddLyraVerificationClient(
            this IServiceCollection services,
            string serverBaseUrl,
            string verifyPath = "api/verification/verify")
        {
            ...
            services.AddSingleton<ILyraClient>(sp =>
                new LyraClient(
                    signing: null,
                    verify: sp.GetRequiredService<VerifyService>()));

            return services;
        }

        /// <summary>
        /// Registers both signing and verification capabilities.
        /// </summary>
        public static IServiceCollection AddLyraClient(
            this IServiceCollection services,
            Action<LyraSigningOptions> configure,
            string serverBaseUrl,
            string verifyPath = "api/verification/verify")
