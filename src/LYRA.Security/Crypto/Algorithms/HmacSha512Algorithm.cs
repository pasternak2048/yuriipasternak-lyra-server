...
{
	/// <summary>
	/// Provides HMAC-SHA-512 signature generation and verification.
	/// Produces Base64-encoded signatures using a shared secret.
	/// This is the default and recommended algorithm in LYRA.
	/// </summary>
	internal sealed class HmacSha512Algorithm : ISignatureAlgorithm
	{
		/// <summary>
		/// Computes a Base64-encoded HMAC-SHA512 signature for the canonical string.
		/// </summary>
		...
		{
			return Hashing.HmacBase64(SignatureType.HmacSha512, stringToSign, secret);
		}
